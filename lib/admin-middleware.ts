...
export async function adminAuthMiddleware(request: NextRequest) {
  try {
    ...
    console.log("Admin middleware - Auth header:", authHeader ? "Present" : "Missing");
    ...
    console.log("Admin middleware - Token preview:", token?.substring(0, 20) + "...");
    ...
    if (!payload.isAdmin && payload.role !== 'admin' && payload.role !== 'superadmin') {
